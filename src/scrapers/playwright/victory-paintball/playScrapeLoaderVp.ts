...
export const scrapeLoaderVp = async (): Promise<void> => {
    const browser = await firefox.launch();
    const page = await browser.newPage();

    const urls = [
        'https://victorypaintball.pl/kategoria/magazynki-i-akcesoria/dye-magazynki-i-akcesoria/',
        'https://victorypaintball.pl/kategoria/magazynki-i-akcesoria/virtue-magazynki-i-akcesoria/',
    ];
